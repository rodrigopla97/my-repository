...
export default function FooterInterface() {
  ...
  return (
    <div className={`flex flex-col items-center justify-between w-screen h-screen ${textColor} font-semibold overflow-y-auto pt-20 px-[5vh] md:px-8`}>
      <div className="flex flex-col md:flex-row items-center justify-center w-full h-full">

        <div className="flex flex-col items-end justify-center w-full md:w-1/3 h-full">
        ...
        <div className="flex flex-col items-center justify-center w-full md:w-2/3 h-full">
          ...
          <div className='flex flex-row items-center justify-center w-full mt-8'>
            ...
            {/* linkedin icon */}
            <a href="https://www.linkedin.com/in/rodrigo-placeres/" target="_blank" rel="noopener noreferrer" title="https://www.linkedin.com/in/rodrigo-placeres/" className={`flex flex-row items-center md:w-[25%] hover:cursor-pointer place-content-center ${isDarkMode ? "hover:text-cvButtonSecondary" : "hover:text-cvButtonPrimary"}`} >
