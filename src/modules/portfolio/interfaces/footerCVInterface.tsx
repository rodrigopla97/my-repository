      ...
      {!isMenuOpen && (
        <>
          ...
          >
            ...
            <div className="flex flex-col py-2">
              ...
              >
                ...
                <i
                  className={`material-symbols-outlined text-base leading-none transition-transform duration-200 ${isCVOpen ? "rotate-180" : ""}`}
                >
                  expand_more
                </i>
              </button>
              ...
              <div
                className={`overflow-hidden transition-all duration-300 ${isCVOpen ? "max-h-40" : "max-h-0"}`}
              >
                <button
                  type="button"
                  onClick={() => {
                    close();
                    openPreview("/CV - Rodrigo Placeres.pdf");
                  }}
          ...
          >
            {!isCurriculumOpen && (
              <span
                className={`absolute inset-0 rounded-full animate-ping opacity-25 ${accentBg}`}
              />
            )}
            <button
              type="button"
