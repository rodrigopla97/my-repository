    ...
    >
      ...
      >
        <div className="flex items-center gap-2 px-3 pt-3 pb-2 flex-shrink-0">
          <button type="button" onClick={() => setInfoUrl(null)} className="flex items-center justify-center text-white/70 hover:text-white transition-colors">
        ...
        <>
          {!isMenuOpen && (
            <button
              ...
              onClick={e => { e.stopPropagation(); setMenuKey(cardKey); }}
            >
          ...
          {isMenuOpen && (
            ...
            >
              <div className="flex items-center justify-between px-3 py-2 flex-shrink-0">
                <span className="text-white text-xs font-semibold uppercase tracking-widest truncate">{site.label}</span>
                <button
                  type="button"
                  onClick={e => { e.stopPropagation(); setMenuKey(null); }}
